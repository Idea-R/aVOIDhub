      ...
      <div className="relative w-full max-w-md mx-4 bg-gray-900 border border-purple-500/20 rounded-2xl shadow-2xl">
        ...
        <div className="p-8 pb-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full mb-6 p-3 bg-white text-gray-900 rounded-lg font-medium hover:bg-gray-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-3"
          >
