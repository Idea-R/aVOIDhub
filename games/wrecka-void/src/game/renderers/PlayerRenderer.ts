...
export class PlayerRenderer {
  ...
  drawPlayer(
    ...
    this.ctx.strokeStyle = palette.playerEdge;
  ...
  drawBall(
    ...
    this.ctx.strokeStyle = palette.ballEdge;
  ...
  private drawBallDetails(
    ...
    // Center highlight
    this.ctx.fillStyle = activeEffects.berserk
      ? "#ffcccc"
      : activeEffects.electrified
        ? "#ffffcc"
        : activeEffects.hyperSpin
          ? "#eeccff"
          : "#eeeeee";
    this.ctx.beginPath();
    this.ctx.arc(
  ...
  private drawSecondBallDetails(
    ...
    this.ctx.beginPath();
    this.ctx.arc(
      ball.x - ballRadius * 0.2,
      ball.y - ballRadius * 0.2,
      ballRadius * 0.15,
      0,
      Math.PI * 2,
    );
