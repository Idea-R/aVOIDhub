              ...
              <tr key={score.id} className="hover:bg-gray-700/30 transition-colors">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <div className="text-sm font-medium text-white">
                        {score.user_profiles?.display_name || score.player_name || 'Anonymous'}
                      </div>
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center space-x-1 text-blue-400">
                    ...
                    <span className="font-semibold">{score.metadata?.wave || '-'}</span>
                  </div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center space-x-1 text-green-400">
                    <Clock className="w-4 h-4" />
                    <span>{score.metadata?.survival_time ? formatTime(score.metadata.survival_time) : '-'}</span>
                  </div>
                </td>
