...
export class RenderCore {
  ...
  private prepareShadowGroups(state: RenderState): void {
    ...
    // Player cursor now handled by unified CursorSystem - no longer rendered here
    // This eliminates the dual cursor issue by having single source of truth
  ...
  private getRenderOrder(): string[] {
    ...
    return [
      ...
      // Player cursor removed - now handled by unified CursorSystem
