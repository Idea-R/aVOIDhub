...
function BoltBadge({ onMeteorDefense }: BoltBadgeProps) {
  ...
  return (
    <>
      ...
      {/* Badge Container with Defense Field - Mobile Safe */}
      <div className="fixed z-50 game-bolt-badge mobile-ui-safe" 
           style={{ 
        ...
        <a 
          ...
          className="block transition-all duration-300 hover:shadow-2xl min-w-[44px] min-h-[44px] flex items-center justify-center"
        >
          <img 
