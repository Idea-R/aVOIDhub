...
export default function SignupModal({ isOpen, onClose, playerScore, playerName }: SignupModalProps) {
  ...
  if (success) {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-[9999] p-4 modal">
        <div className="bg-gray-900 rounded-lg shadow-2xl border border-green-500 max-w-md w-full p-8 text-center ui-element">
  ...
  if (showForgotPassword) {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-[9999] p-4 modal">
        <div className="bg-gray-900 rounded-lg shadow-2xl border border-cyan-500 max-w-md w-full ui-element">
