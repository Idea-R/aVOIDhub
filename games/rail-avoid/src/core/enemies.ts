...
export const ENEMY_DEFS: Record<EnemyType, EnemyDef> = {
  ...
  crawler: E({ type: 'crawler', name: 'Crawler', layer: 'ground', hp: 160, speed: 50, damage: 18, attackCooldown: 4, range: 34, armor: 0.65, resist: { bullet: 0.35, shell: 2, energy: 1.2 }, threatCost: 12, radius: 18, color: 0xb0743c, xp: 40 }),
  harpy: E({ type: 'harpy', name: 'Harpy Drone', layer: 'air', hp: 40, speed: 96, damage: 5, attackCooldown: 2.2, range: 70, threatCost: 6, radius: 12, resist: { bullet: 0, shell: 1, energy: 1.3, fire: 0.4 }, color: 0xe8a94f, xp: 18 }),
  sapper: E({ type: 'sapper', name: 'Sapper', layer: 'ground', hp: 30, speed: 70, damage: 60, attackCooldown: 4, range: 20, threatCost: 7, radius: 9, color: 0x60c0a0, xp: 22 }),
  ...
  boss_wagon: E({ type: 'boss_wagon', name: 'The Iron Wagon', layer: 'ground', hp: 1400, speed: 0, damage: 18, attackCooldown: 2.6, range: 340, armor: 0.5, resist: { bullet: 0.4, shell: 1.6, energy: 1, fire: 0.5 }, threatCost: 0, radius: 40, color: 0x8a8f9a, xp: 500 }),
