...
export const CAR_DEFS: Record<CarType, CarDef> = {
  ...
  cargo: base({ type: 'cargo', name: 'Cargo Hold', short: 'CRGO', desc: '+60 to every storage cap. Supplies ammo to weapons within 2 cars.', tier: 1, cost: 20, hp: 110, weight: 20, storage: { rails: 60, scrap: 60, coal: 40, ammo: 60, food: 60 }, ammoSupplier: true, color: 0x8b6b4a }),
  ...
  gatling: base({ type: 'gatling', name: 'Gatling Turret', short: 'GATL', desc: 'Rapid bullets vs ground. Weak against armour, useless against air and wisps.', tier: 1, cost: 30, hp: 100, weight: 18, powerUse: 2, heatGen: 2,
    weapon: W({ kind: 'gatling', damageClass: 'bullet', range: 230, damage: 8, cooldown: 0.22, ammoPerShot: 0.25, heatPerShot: 0.35 }), color: 0xe86f6f }),
  cannon: base({ type: 'cannon', name: 'Cannon Car', short: 'CANN', desc: 'Slow shells with splash. Double damage vs armour. Ground only. Hot.', tier: 2, cost: 48, hp: 120, weight: 30, powerUse: 3, heatGen: 4,
  ...
  flak: base({ type: 'flak', name: 'Flak Battery', short: 'FLAK', desc: 'Bursts that shred air units. Cannot target ground.', tier: 2, cost: 40, hp: 100, weight: 22, powerUse: 3, heatGen: 2,
  ...
  coach: base({ type: 'coach', name: 'Passenger Coach', short: 'COCH', desc: 'Carries 12 passengers. Passengers eat food and pay rails when delivered.', tier: 1, cost: 24, hp: 100, weight: 20, passengerCap: 12, color: 0xd6b4f0 }),
