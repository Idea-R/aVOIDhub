...
export const CAR_DEFS: Record<CarType, CarDef> = {
  ...
  gatling: base({ type: 'gatling', name: 'Gatling Turret', short: 'GATL', desc: 'Rapid bullets vs ground. Weak against armour, only 25% effective against air, useless against wisps.', tier: 1, cost: 30, hp: 115, weight: 18, powerUse: 2, heatGen: 2,
