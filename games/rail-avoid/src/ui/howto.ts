...
const CARDS: Array<{ title: string; text: string }> = [
  ...
  { title: 'Cars & adjacency', text: 'Generators power cars within 3 positions; too many consumers → brownout. Heat diffuses to neighbours (≥80 damage, ≥100 fire). Ammo in the top bar is shared stock, but Gatling, Cannon, and Flak cars need a Cargo Hold, Foundry, or Armoured Cargo within 2 positions to deliver it. Starter emergency couplers reconnect the train through region 2; after that, a destroyed car can strand everything behind it.' },
  ...
  { title: 'Settlements', text: 'Reach settlements before their deadline: collect cargo, passengers and specialists. Yards repair, upgrade and sell cars. Passengers eat food, trigger events, and pay rails when delivered.' },
