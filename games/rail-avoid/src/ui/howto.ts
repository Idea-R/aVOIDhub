...
const CARDS: Array<{ title: string; text: string }> = [
  ...
  { title: 'Cars & adjacency', text: 'Generators power cars within 3 positions; too many consumers → brownout. Heat diffuses to neighbours (≥80 damage, ≥100 fire). Weapons need an ammo supplier within 2 cars. Starter emergency couplers reconnect the train through region 2; after that, a destroyed car can strand everything behind it.' },
