...
2. After each workstream: `npm run test`, `npm run verify`, `npm run perf:headed`, then sync into `C:\dev\aVOID-main\games\rail-avoid` and push to deploy (see the memory notes in README "Deploy").
